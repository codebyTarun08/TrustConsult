        ...
        <section className='flex justify-center w-full px-4'>
            <div className='w-full border border-gray-700 max-w-6xl p-10 rounded-xl shadow-2xl bg-gradient-to-br from-richblue-800 to-gray-800 text-white'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                    {fieldData.map((field) => (
                        <div key={field.id} className='bg-prime-5/30 bg-opacity-50 p-6 rounded-lg shadow-inner border border-gray-700 hover:bg-opacity-70 transition-all duration-300 hover:scale-95'>
