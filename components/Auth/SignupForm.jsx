...
const SignupForm = () => {
    ...
    return (
        <div className='my-10 flex flex-col gap-y-5'>
            <div className='flex px-3 h-14 py-2 justify-evenly border-b border-gray-600 text-cyan-500 bg-richblack-800 w-4/5 rounded-xl'>
                <button 
            ...
            <form
                ...
                <div className='flex mt-5'>
                    <label>
                        ...
                        <input
                            ...
                            className='py-2 bg-richblack-800 text-cyan-600 w-4/5 px-5 rounded-md border-b-[1px] border-b-slate-500'
                ...
                <label>
                    ...
                    <input
                        ...
                        className='py-2 bg-richblack-800 text-cyan-600 w-4/5 px-5 rounded-md border-b-[1px] border-b-richblack-200'
                        onChange={changeHandler}
                    />
                </label>
                ...
                <div className='flex relative'>
                    ...
                    <input
                        ...
                        className='py-2 bg-richblack-800 text-cyan-600 px-5 rounded-md border-b-[1px] border-b-richblack-200 w-4/5'
                        onChange={changeHandler} />
                        <span
                            className='absolute top-[35px] right-[325px] text-cyan-600 cursor-pointer z-10 '
                    ...
                    <input
                        ...
                        onChange={changeHandler} />
                        <span
                            className='absolute top-[35px] right-28 text-cyan-600 cursor-pointer z-10'
                ...
                <button className='px-10 py-4 bg-blue-300 cursor-pointer w-4/5 rounded-xl active:scale-95 transition-all duration-200'>
                    Signup
                </button>
            </form>
