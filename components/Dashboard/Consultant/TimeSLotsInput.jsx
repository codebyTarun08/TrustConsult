    ...
    <div className="my-4">
      ...
      <div className="flex gap-2 items-center justify-around">
        ...
        <input
          ...
          placeholder="Rate"
          className="border p-4 rounded-lg bg-gray-800 text-white w-26 h-14"
        />

        <button
          type="button"
          onClick={handleAddSlot}
          className="bg-caribbeangreen-200 text-richblack-900 px-4 py-2 rounded-lg font-semibold w-32 h-14"
        >
          Add
        </button>
      </div>
